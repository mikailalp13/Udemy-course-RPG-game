...
public class Skill_Base : MonoBehaviour
{
    ...
    public void ResetCooldownBy(float cooldown_reduction) => last_time_used = last_time_used + cooldown_reduction;
    public void ResetCooldown() => last_time_used = Time.time;
}
