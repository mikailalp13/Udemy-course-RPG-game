...
public class ElementalEffectData 
{
    ...
    public ElementalEffectData(Entity_Stats entityStats, DamageScaleData damageScale)
    {
        ...
        total_burn_damage = entityStats.offense.FireDamage.GetValue() * damageScale.burn_damage_scale;

        shock_duration = damageScale.shock_duration;
        shock_damage = entityStats.offense.LightningDamage.GetValue() * damageScale.shock_damage_scale;
